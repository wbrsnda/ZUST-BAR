...
public class FriendDaoImpl implements FriendDao
{
	...
	/**
	 * @Description   我关注的人或者黑名单--分页查询--对象集合 friend表-->user表
	 * @param userId 当前用户的id值
	 * @param status  查询条件 0--黑名单--1--关注
	 * @param currentPage 当前页
	 * @param pageSize 页面大小
	...
	/**
	 * @Description 我关注的人或者黑名单- 找出其中符合条件的记录数 user表
	...
	/**
	 * @Description  我关注的人或者黑名单--分页查询--对象集合
